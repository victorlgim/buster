...
from .serializers import (UserSerializer, CustomJWTSerializer, UserPatch, UserSpecificSerializer,)
...
class UserSpecificView(APIView):
    ...
    def patch(self, request, user_id):
        ...
        serializer = UserPatch(user, data=request.data, context={"request": request, "user_id": user_id})
        if serializer.is_valid():
